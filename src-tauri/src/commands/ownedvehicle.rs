...
// fn map_truck_name(brand_id: &str) -> String {
//     match brand_id {
//         "volvo.fh_2024" => "Volvo FH16 2024".to_string(),
//         "volvo.fh16_2012" => "Volvo FH16 2012".to_string(),
//         "volvo.fh16" => "Volvo FH16 Classic".to_string(),
//         "scania.r_2016" => "Scania R NG".to_string(),
//         "scania.s_2016" => "Scania S NG".to_string(),
//         "scania.r" => "Scania R Streamline".to_string(),
//         "scania.streamline" => "Scania Streamline".to_string(),
//         "man.tgx_2020" => "MAN TGX 2020".to_string(),
//         "man.tgx_euro6" => "MAN TGX Euro 6".to_string(),
//         "man.tgx" => "MAN TGX".to_string(),
//         "daf.xf_2021" => "DAF XF 2021".to_string(),
//         "daf.xg_2021" => "DAF XG 2021".to_string(),
//         "daf.xf_euro6" => "DAF XF Euro 6".to_string(),
//         "daf.xf" => "DAF XF105".to_string(),
//         "daf.xd" => "DAF XD".to_string(),
//         "mercedes.actros_2014" => "Mercedes-Benz New Actros".to_string(),
//         "mercedes.actros" => "Mercedes-Benz Actros".to_string(),
//         "renault.t" => "Renault T Range".to_string(),
//         "renault.premium" => "Renault Premium".to_string(),
//         "renault.magnum" => "Renault Magnum".to_string(),
//         "iveco.hiway" => "Iveco Stralis Hi-Way".to_string(),
//         "iveco.stralis" => "Iveco Stralis".to_string(),
//         _ => brand_id.replace("_", " ").to_string(),
//     }
