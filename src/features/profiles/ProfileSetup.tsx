        ...
        try {
            ...
            if (selected) {
                ...
                if (lower.endsWith("euro truck simulator 2") || lower.endsWith("american truck simulator")) {
                    // We'll check if a profiles folder exists inside via our Rust command
                    // but for simplicity here we can just try appending it and let get_game_profiles handle the check
            ...
            >
                ...
                <div ref={dropdownRef} className="relative">
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium border transition-all duration-200 hover:bg-zinc-500/10 max-w-[320px] disabled:opacity-40"
                        style={{
                    ...
                    >
                        <HardDrive size={14} style={{ color: 'var(--accent)' }} className="shrink-0" />
